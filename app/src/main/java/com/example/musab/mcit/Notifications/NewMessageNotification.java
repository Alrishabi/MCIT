...
public class NewMessageNotification {
     ...
     */
    private static final String NOTIFICATION_TAG = "NewBroadCast";
    /**
    ...
    public static void notify(final Context context,
                              final String exampleStringTitle,
                              final String exampleStringType,
                              final String exampleStringContent,
                              final int number) {
        ...
        final String ticker = exampleStringType;
        final String title =  exampleStringTitle;
        final String text =  exampleStringContent;
